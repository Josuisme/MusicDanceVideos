...
<div className="flex min-h-screen w-full flex-wrap content-center justify-center p-5 bg-gray-200">
        <div className="grid grid-cols-2 gap-3">
          <div className="w-80 bg-white p-3">
            ...
            <Link href="https://www.youtube.com/results?search_query=musica">
          ...
          <Link href="https://www.facebook.com/search/top/?q=musica">
...
export default GaleryOfItemsMusic
const Img=tw.img
`
