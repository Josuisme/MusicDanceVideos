...
import BigTitlePrinc from './components/BigTitlePrinc';
...
export default function Home() {
  ...
  return (
    <Wrapper>
      <Header>
        <HeaderImg src="https://cdn.pixabay.com/photo/2018/03/29/15/21/silhouette-3272487_960_720.jpg"/>
      <Nav/>
      </Header>
      <BigTitlePrinc/>
      <PagePrinc/>
...
`
h-12 flex float-right rounded-full border border-gray-200 p-px
`
